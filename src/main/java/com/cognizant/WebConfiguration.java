...
import com.cognizant.interceptor.LoggingInterceptor;
...
public class WebConfiguration implements WebMvcConfigurer {
	...
	private ApiInfo generateApiInfo() {
		...
		return new ApiInfoBuilder().title("Cognizant - Full Stack coding challenge").version("Version 1.0").description(
				"This service is to check the technology knowledge of a applicant for Full Stack coding at Cognizant.")
